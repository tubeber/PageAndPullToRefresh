 ...
 * @author 13071499
 */
public class RefreshImageListView extends ListView implements OnScrollListener {
     ...
     * 图片初始固定填充值
     */
    private static final int IMAGE_PADDING = -150;
    ...
    public RefreshImageListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RefreshImageListView(Context context, AttributeSet attrs, int defStyle) {
