...
import com.king.refresh.widget.waterfall.internal.WaterfallListView;

/**
 * @author huewu.ynag
 * @date 2012-11-06
 */
public class MultiColumnListView extends WaterfallListView {
	...
	private void init(AttributeSet attrs) {
		...
		if( attrs == null ){
			...
			int landColNumber = a.getInteger(R.styleable.MultiColumnListView_landscapeColumnNumber, -1);
			int defColNumber = a.getInteger(R.styleable.MultiColumnListView_columnNumber, -1);
			...
			mColumnPaddingLeft = a.getDimensionPixelSize(R.styleable.MultiColumnListView_columnPaddingLeft, 0);
			mColumnPaddingRight = a.getDimensionPixelSize(R.styleable.MultiColumnListView_columnPaddingRight, 0);
			a.recycle();
		}
