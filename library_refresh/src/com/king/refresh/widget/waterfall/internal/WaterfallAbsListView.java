...
package com.king.refresh.widget.waterfall.internal;
 ...
 */
public abstract class WaterfallAbsListView extends WaterfallAdapterView<ListAdapter> implements
ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnTouchModeChangeListener {
     ...
     * Acts upon click
     */
    private WaterfallAbsListView.PerformClick mPerformClick;
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScroll(WaterfallAbsListView view, int firstVisibleItem, int visibleItemCount,
                int totalItemCount);
    }

    public WaterfallAbsListView(Context context) {
        super(context);
        initAbsListView();
    ...
    public WaterfallAbsListView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.absListViewStyle);
    }

    public WaterfallAbsListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(WaterfallAbsListView.this, originalView,
                ...
                switch (mTouchMode) {
                    ...
                    case TOUCH_MODE_DONE_WAITING:
                        ...
                        if (child != null && !child.hasFocusable()) {
                            ...
                            final WaterfallAbsListView.PerformClick performClick = mPerformClick;
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new WaterfallAbsListView.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof WaterfallAbsListView.LayoutParams;
    }
    ...
    public void reclaimViews(List<View> views) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            WaterfallAbsListView.LayoutParams lp = (WaterfallAbsListView.LayoutParams) child.getLayoutParams();
     ...
     *        in the recycler.
     *
     * @see android.widget.WaterfallAbsListView.RecycleBin
    ...
    class RecycleBin {
        ...
        void addScrapView(View scrap) {
            ...
            WaterfallAbsListView.LayoutParams lp = (WaterfallAbsListView.LayoutParams) scrap.getLayoutParams();
            if (lp == null) {
                return;
            }
        ...
        void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    int whichScrap = ((WaterfallAbsListView.LayoutParams) victim.getLayoutParams()).viewType;
